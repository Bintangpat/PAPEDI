...
export default function MentorLayout({
  ...
  useEffect(() => {
    ...
    // Tanpa ini, saat user=null (loading), isAuthenticated=false
    // dan redirect langsung ke login padahal user sudah login.
    if (loading) return;
  ...
  // Tampilkan loading saat masih verifikasi auth
